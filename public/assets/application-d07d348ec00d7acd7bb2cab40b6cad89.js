...
(function() { this.JST || (this.JST = {}); this.JST["comments/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>New Comment</h2>\n<form>\n\t\n\t<label for="restaurant_comment">Comment</label>\n\t<textarea id="restaurant_comment" name="restaurant[comment]" rows="8" cols="40" placeholder="Enter comment..."></textarea>\n\n\t<input type="submit" name="Submit">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid" id="app-view">\n  <div class="row">\n    <div class="restaurant-slider col-xs-4 sidebar">\n      <form id="reorder" action="index.html" method="post">\n        <ul id="sort-by">\n          <h4 class="sortby-title text-center">Sort By</h4>\n\n          <div class="row sortby1">\n            <div class="col-xs-6">\n              <li>\n                <a class="sort" id="distance" href="#">Distance</a>\n              </li>\n            </div>\n\n            <div class="col-xs-6">\n              <li>\n                <a class="sort" id="rating" href="#">Highest Rated</a>\n              </li>\n            </div>\n          </div>\n\n          <div class="row sortby2">\n            <div class="col-xs-6">\n              <li>\n                <a class="sort" id="low-price" href="#">Lowest Bottomless Price</a>\n              </li>\n            </div>\n\n            <div class="col-xs-6">\n              <li>\n                <a class="sort" id="high-price" href="#">Highest Bottomless Price</a>\n              </li>\n            </div>\n          </div>\n\n          <div class="row">\n            <div class="col-xs-12">\n              <li>\n                <a class="sort" id="most-reviewed" href="#">Most Reviewed</a>\n              </li>\n            </div>\n          </div>\n        </ul>\n\n        <div id="checkboxes" class="row btm-checkbox text-center">\n          <div class="col-xs-12">\n            <label for="btm-weekday">\n              Bottomless Weekdays!<input id="btm-weekday" type="checkbox" id="btm-weekday">\n            </label>\n\n            <label id="open" for="open">\n              Bottomless Now!<input id="open-now" type="checkbox" id="open">\n            </label>\n          </div>\n        </div>\n      </form>\n      <ul class="restaurants-index nav nav-sidebar"></ul>\n      <div class="row" class="show-more">\n        <div class="col-xs-12">\n          <div class="search-more">\n            <button class="show-more">Show More Results</button>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <div id="map-container" class="col-xs-8">\n      <div id="map-canvas"></div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid rest-index">\n    <div class="row" id="',  restaurant.escape("name") ,'-img">\n      <a class="list-item" href="/#',  restaurant.escape("id") ,'"\n        target="_blank">\n      <div class="col-xs-12">\n        <img class="restaurant" src="',  restaurant.escape("image_url") ,'" alt="',  restaurant.escape("name") ,'"\n        height="" width=""/>\n      </div>\n    </div>\n\n    <div class="row">\n      <div class="row address_name">\n        <div class="row">\n          <div class="col-xs-1"></div>\n          <div class="col-xs-12">\n            <div id="',  restaurant.escape("name") ,'-info" class="col-xs-12">\n              <p class="rest-info place-name">',  restaurant.escape("name") ,'</p>\n            </div>\n\n          <div class="address_name row">\n            <div id="',  restaurant.escape("name") ,'-address" class="col-xs-12">\n              <p class="rest-info place-address">',  restaurant.display_address() ,'</p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n      <div class="row">\n        <div id="',  restaurant.escape("name") ,'-hours" class="col-xs-12">\n          <p class="rest-info place-hrs">Is it time for mimosas? ',  restaurant.parse_time() ,'</p>\n        </div>\n      </div>\n\n      <div class="row">\n        <div id="',  restaurant.escape("name") ,'-hours" class="col-xs-12">\n          <p class="rest-info place-hrs">Bottomless brunch today? ',  restaurant.escape("brunch_days") ,'</p>\n        </div>\n      </div>\n    </a>\n\n    <div class="row">\n      <div id="',  restaurant.escape("name") ,'-link" class="col-xs-12">\n        <a href="',  restaurant.escape("url") ,'" target="_blank">Website</a>\n      </div>\n    </div>\n\n    <div class="row">\n      <a class="list-item" href="/#',  restaurant.escape("id") ,'-',  restaurant.escape("name") ,'"\n        target="_blank">\n        <div id="',  restaurant.escape("name") ,'-excerpt" class="col-xs-12">\n          <p class="rest-info">',  restaurant.get("review").body ,'</p>\n        </div>\n      </a>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main class="row rest-details">\n  <div class="row">\n    <div class="col-xs-12 text-center img-responsive">\n      <div class="show-img container">\n        <img class="show-img" src="',  restaurant.escape("image_url") ,'" alt="',  restaurant.escape("name") ,'"/>\n      </div>\n    </div>\n  </div>\n\n  <div class="show-background">\n    <div class="row rest_attr">\n      <div class="col-xs-12 text-center">\n        <p id="rest-show-name" class=\'rest-info\'>',  restaurant.escape("name") ,'</p>\n      </div>\n\n      <div class="col-xs-12 text-center">\n        ');  if (restaurant.attributes.display_address) { ; __p.push('\n          <p id="rest-show-addy" class="rest-info">',  restaurant.display_address() ,'</p>\n        ');  } ; __p.push('\n      </div>\n    </div>\n\n    <div class="bottom-half-show-info row">\n      <div class="row">\n        <div class="col-xs-6 text-center">\n          <div class="container">\n            <div class="glyphicons glyphicons-iphone-shake"></div>\n          </div>\n          <p class="rest-info" id="rest-show-phone">',  restaurant.escape("display_phone") ,'</p>\n        </div>\n\n        <div class="col-xs-6 text-center">\n          <a id="rest-link-show" href="',  restaurant.escape("url") ,'" target="_blank">website</a>\n        </div>\n      </div>\n\n      <div class="row">\n        <div class="col-xs-6 text-center">\n          ');  if (restaurant.attributes.open_hour) { ; __p.push('\n            <p id="open-hrs" class="rest-info">Bottomless Hours: ',  restaurant.parse_time() ,'</p>\n          ');  } ; __p.push('\n        </div>\n\n        <div class="col-xs-6 text-center">\n          <p id="open-days" class="rest-info">Bottomless Days: ',  restaurant.escape("brunch_days") ,'</p>\n        </div>\n      </div>\n    </div>\n\n    <div class="rest-show-review row">\n      <div class="col-xs-12 text-center">\n        ');  if (restaurant.attributes.reviews) { ; __p.push('\n          <p id="rest-show-review">',  restaurant.attributes.reviews[0].body ,'</p>\n        ');  } ; __p.push('\n      </div>\n    </div>\n\n    <div class="row">\n      <div class="col-xs-12 text-center">\n        <a href="#/restaurants/new">New Review</a>\n      </div>\n    </div>\n  </div>\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="launch-app section">\n  <div class="jumbotron vertical-center">\n    <div class=\'containter signin text-center\'>\n      <div class="row">\n        <div class="col-xs-12">\n          <img class="logo" src="/assets/mosa_logo_high_res_rgb-8.png" alt="mosa_logo" />\n        </div>\n      </div>\n\n      <form class="find-location" action="index.html" method="post">\n        <div class="row">\n          <div class="col-xs-12">\n            <button type="button" class="btn btn-primary current-location">\n              Use Current Location\n            </button>\n          </div>\n        </div>\n\n        <div class="row">\n          <div class="col-xs-12">\n            <input type="text" class="zipcode" name="zipcode"\n              placeholder="Enter Your Zipcode">\n          </div>\n        </div>\n\n        <div class="row">\n          <div class="col-xs-12">\n            <button class="submit" name="submit">Submit!</button>\n          </div>\n        </div>\n      </form>\n    </div>\n  </div>\n</section>\n');}return __p.join('');};
}).call(this);
...
;
window.Mosa.Models.Review = Backbone.Model.extend({
  urlRoot: "/api/reviews"
})
;
