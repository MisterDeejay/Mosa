...
window.Mosa.Views.RestaurantsIndex = Backbone.CompositeView.extend({
  ...
  events: {
    ...
    'mouseenter .rest-index': 'enterRestaurantItem',
    'mouseleave .rest-index': 'leaveRestaurantItem'
  },
  ...
  enterRestaurantItem: function(event) {
