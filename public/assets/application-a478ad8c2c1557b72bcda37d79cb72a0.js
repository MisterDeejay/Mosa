...
window.Mosa.Views.MapShow = Backbone.CompositeView.extend({
  ...
  addMarker: function(restaurant) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      console.log("#" + restaurant.get('id'));
      $restaurant = $(restListItem);
